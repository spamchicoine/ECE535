...
def get_args():
    ...
    parser.add_argument('--dataset',type=str, default='mnist',choices=['mnist','cifar10','fmnist'],help='dataset name')
    ...
    parser.add_argument('--n_clients',type=int, default=10, help='the number of clients')
