...
# GLOBAL PARAMETERS
OPTIMIZERS = ['qffedsgd', 'qffedavg', 'afl', 'sgd', 'tilting']
DATASETS = [ 'synthetic', 'vehicle', 'sent140', 'shakespeare',
'synthetic_iid', 'synthetic_hybrid', 
'fmnist', 'adult', 'adult_one_user', 'mnist', 'cifar']   # fmnist: fashion mnist used in the AFL paper


MODEL_PARAMS = {
    'adult.lr': (2, ), # num_classes,
    'adult_one_user.lr': (2, ), # num_classes,
    ...
    'voc.cnn':(20, ), # num_classes
    'cifar.inception': (10, ), # num_classes
}
